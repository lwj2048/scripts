...
def check_env_dependence():
    ...
    print(
        f'cuda_version:{cuda_version}, gcc_version:{gcc_version}, cudnn_version:{cudnn_version}, openmpi_version:{openmpi_version}, python_version:{python_version}, nccl_version:{nccl_version}')


def update_markdown_table(md_file, env, table_name, cuda_version, nccl_version, openmpi_version, python_version,
                          gcc_version):
...
if __name__ == "__main__":
    ...
    print(
        f'cuda_version:{cuda_version}, gcc_version:{gcc_version}, cudnn_version:{cudnn_version}, openmpi_version:{openmpi_version}, python_version:{python_version}, nccl_version:{nccl_version}')
    update_markdown_table(md_file, env, table_name, cuda_version, nccl_version, openmpi_version, python_version,
                          gcc_version)
